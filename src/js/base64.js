...
(function(){
    MainJS = {
        ...
        encode : function (input) {
            ...
            output = _this.replaceAll(output,"/","_a");
            output = _this.replaceAll(output,"+","_b");
            output = _this.replaceAll(output,"=","_c");
            return output;
        },
        ...
        var i = 0;
            input = _this.replaceAll(input,"_a","/");
            input = _this.replaceAll(input,"_b","+");
            input = _this.replaceAll(input,"_c","=");
